...
ssss=det(matrixbc1+matrixbc2*DeltaT)
tezhengzhi=eig(matrixbc1+matrixbc2*DeltaT)
tezhengzhiji=1;
% tezhengzhimax=max(tezhengzhi);
for i=1:size(tezhengzhi)
    tezhengzhi(i)=log10(tezhengzhi(i))
    tezhengzhiji=tezhengzhiji*tezhengzhi(i);
end
tezhengzhiji
