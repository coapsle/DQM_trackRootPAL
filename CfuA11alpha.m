function zhi=CfuA11alpha(e0,laGPL,h,bbi,tbi,EGPL,nuGpL,rhoGpL,aaGpL,em,num,rhom,aam,LGPL);
%syms z
...
F=@(z)(z.*0+((em*((3+3*xiL*etaL*sA)/(8-8*etaL*sA)+(5+5*xiB*etaB*sA)/(8-8*etaB*sA)))*(1-e0*cos(pi*z/h)))./(1-(0.342*(nuGpL*sA+num*(1-sA))*(1-1.121*(1-(1-e0*cos(pi*z/h)).^(1/2.3))).^2+(0.526*(nuGpL*sA+num*(1-sA))-0.221)*(1-1.121*(1-(1-e0*cos(pi*z/h)).^(1/2.3)))+0.132*(nuGpL*sA+num*(1-sA))+0.221).^2).*aa);
